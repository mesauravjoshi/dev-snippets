...
import { NodeJsIcon } from '@/assets/icons/Icons';
import { Outlet } from 'react-router-dom';

const snippetsData = [
  { id: 'Paginate', name: 'Paginate API', route: '/paginateApi' },
];
      ...
      <div className="border-b border-border">
        <div className="container mx-auto px-6 py-6">
          ...
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl flex items-center bg-[#0f2a1c] justify-center">
              <span className="text-[#22c55e] ">
                <NodeJsIcon />
              </span>
            </div>
            <div>
              <h1 className="text-2xl font-bold text-foreground">NodeJs Snippets</h1>
              ...
              {snippetsData.map((snippet, index) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <span className="text-sm font-medium text-[#22c55e]">{snippet.name}</span>
                  </td>
